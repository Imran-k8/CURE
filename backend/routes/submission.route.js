...
import {submit, listPending, getSubmissionDetails, publish, reject, uploadfile} from "../controllers/submission.controller.js"
...
router.post("/submit", protectRouteVerified, submit);
